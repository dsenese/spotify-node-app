...
router.get('/callback', async (ctx) => {
 // your application requests refresh and access tokens
  ...
  var storedState = ctx.cookies ? ctx.cookies[stateKey] : null;
  ...
  if (state === null || state !== storedState) {
    ...
    var authOptions = {
      ...
      headers: {
        'Authorization': 'Basic ' + (new Buffer(process.env.CLIENT_ID + ':' + process.env.CL).toString('base64'))
      },
      json: true
    };

...
router.get('/callback', async (ctx) => {
 // your application requests refresh and access tokens
  ...
  if (state === null || state !== storedState) {
    ...
    var authResults = await request.post(authOptions, async function(error, response, body) {
      if (!error && response.statusCode === 200) {
        ...
        authResults = {'access_token': null, 'refresh_token': null, 'user': null, 'status': 'invalid_token'};
      }
    });
    await authResults;

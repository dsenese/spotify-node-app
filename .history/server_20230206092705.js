...
router.get('/isrc/:id', async (ctx) => {
    ...
    request.get(options, function(error, response, body) {
        ...
        console.log('TRACK RESULTS', trackName, artistList, spotifyImageUri);
...
function parseTrackMetaData(body) {
    ...
    var spotifyImageUri = body.tracks.items[index].album.images[0].uri;

    console.log('TRACK RESULTS', trackName, artistList, spotifyImageUri, popularity);
